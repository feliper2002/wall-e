...
class AppColors {
  ...
  static const neckRectangle124 = <Color>[
    Color(0xffBB8F70),
    Color(0xffA16548),
    Color(0xff4D2624),
  ];

  static const neckRectangle123 = <Color>[
    Color(0x4192593C),
    Color(0xFF180401),
  ];

  static const neckRectangle114 = Color(0xff120201);

  static const neckRectangle195 = <Color>[
    Color(0xffBCA998),
    Color(0xffBCA998),
    Color(0xff572215),
  ];
  ...
  static const neckRectangle141 = <Color>[
    Color(0xff3B271E),
    Color(0xff745E4C),
    Color(0xff372A24),
  ];
  ...
  static const armsGradientTop = <Color>[
    Color(0xffD4985E),
    Color(0xffC25C11),
  ];
  static const armsGradientBottom = <Color>[
    Color(0xff441C1A),
    Color(0xff613E2B),
    Color(0xff4B2F24),
  ];

  static const armsGearRadialGradient = <Color>[
    Color(0xff1A0003),
    Color(0xff4C3527),
  ];
...
////////////////////////////// {ARMS SUPPORT} //////////////////////////////
  ...
  static const eyeBaseRadial = <Color>[
    Color(0xffBBB1AF),
    Color(0xff948276),
    Color(0xff5B5148),
  ];

  static const eyeBigBoltRadial = <Color>[
    Color(0xff7C716D),
    Color(0xff312B27),
  ];

  static const eyeSmallBoltRadial = <Color>[
    Color(0xff6F6B68),
    Color(0xff010401),
  ];

  static const pupilBaseRadial = <Color>[
    Color(0xff2B2823),
    Color(0xff76736A),
  ];

  static const pupilBase2Radial = <Color>[
    Color(0xff43413E),
    Color(0xff534F4B),
  ];

  static const pupilBase3Radial = <Color>[
    Color(0xff0E0D12),
    Color(0xff2F292B),
  ];

  static const pupilBase4Radial = <Color>[
    Color(0xff4F4843),
    Color(0xff352F2C),
  ];
